...
//Задание 3.4 и 3.5
@DisplayName("Тестовый набор SecondLoginTests - Задание 3.4 и 3.5")
@TestMethodOrder(MethodOrderer.MethodName.class)
public class FouthLoginTests3_5 {
    ...
    @Test
    @DisplayName("01. Корректные логин и пароль - успешный вход в систему по нажатию кнопки Login")
